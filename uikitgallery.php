...
class PlgFieldsUikitgallery extends FieldsListPlugin
{
	...
	public function onCustomFieldsPrepareDom($field, DOMElement $parent, JForm $form)
	{
        ...
        $fieldNode->setAttribute('label', 'PLG_FIELDS_UIKITGALLERY_PARAMS_DIRECTORY_LABEL');
        $fieldNode->setAttribute('description', 'PLG_FIELDS_UIKITGALLERY_PARAMS_DIRECTORY_DESC');
